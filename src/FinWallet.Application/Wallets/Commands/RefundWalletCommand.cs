...
public sealed record RefundWalletCommand(Guid WalletId, decimal Amount, string Reference) : IRequest<TransactionDto>;
...
public sealed class RefundWalletCommandHandler : IRequestHandler<RefundWalletCommand, TransactionDto>
{
    ...
    public async Task<TransactionDto> Handle(RefundWalletCommand request, CancellationToken cancellationToken)
    {
        ...
        var tx = wallet.ApplyCredit(request.Amount, request.Reference, TransactionType.Refund);
